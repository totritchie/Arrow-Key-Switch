ArrowKeySwitch is a utility designed to modify your keyboard's functionality, allowing users to utilize the I, J, K, L keys as arrow keys when pressing the CapsLock key.
